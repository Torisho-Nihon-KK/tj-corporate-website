...
export default function Header() {
    ...
    return (
        <span>
            <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between rounded-b-2xl sticky top-0 z-50 font-primary bg-white/5 backdrop-blur-[25px]">
                <div className="w-full flex items-center pl-6 pr-3">
